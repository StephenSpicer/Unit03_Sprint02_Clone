...
- In the Northwind database, what is the type of relationship between the `Employee` and `Territory` tables?
   - EMPLOYEE ID IS A PRIMARY KEY ON EMPLOYEE TERRITORY. TERRITORY IS OBVIOUSLY DEPENDENT ON EMPLOYEE, SINCE THE ID COLUMN IS HOW TERRITORY IS STRUCTURED. IM FAIRLY CERTAIN BASED ON MY UNDERSTANDING OF SQL AND RELATIONSHIPS IN DATABASES THAT THIS TYPE OF RELATIONSHIP CAN BE DESCRIBES AS A "ONE TO MANY" RELATIONSHIP. 

- What is a situation where a document store (like MongoDB) is appropriate, and what is a situation where it is not appropriate?
    - AN EXAMPLE OF WHEN MONGO DB WOULD BE APPROPRIATE WOULD BE WHEN ONE IS DEALING WITH A MASSIVE AMOUNT OF DATA FROM A VARIETY OF SOURCES, ALL COMING IN DAILY WITH SIMILAR CHARACTERISTICS BUT IN A RELATIVELY UNSTRUCTED WAY. FOR EXAMPLE LIKE LOTS OF TWEETS ON A DAILY BASIS. AN EXAMPLE OF DATA THAT WOULD PROBABLY NOT PREFER A DOCUMENT STORE WOULD BE A BANK APP, LIKE A USER ACCOUNT THAT IS LINKED TO A BANK ACCOUNT WITH PERMISSIONS AND OPTIONS, TRANSFERS, ETC - USING WHAT WE CALL STRUCTURED DATA WITH LOTS OF RELATIONSHIPS AND DEPENDENCIES. I TEND TO THINK OF IT AS MONOGO / DOC STORE BEING GOOD FOR "BIG DATA" AND RELATIONAL BEING GOOD FOR STRUCTURED DATA. 

- What is "NewSQL", and what is it trying to achieve?
    - NEWSQL IS ATTEMPTING TO COMBINE THE STRENGTHS OF NOSQL SYSTEMS SUCH AS SCALABILITY WITH THE STRENGTHS OF SQL SYSTEMS LIKE STRUCTURE AND REALTIONONSHIPS. THE END GOAL HERE IS BASICALLY TO ATTEMPT TO KEEP ACID PROPERTIES INTACT FROM SQL SYSTEMS WHILE ALSO GETTING SOME OF THE BENEFITS THAT ARE NOT INCLUDED THERE BUT EXIST INSIDE OF NOSQL SYSTEMS.  
